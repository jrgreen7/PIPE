...
genTab = remote_dir + 'PIPE/code/genTab/genTab'
genTab_hostfile = local_dir + 'PIPE/code/genTab/genTab_hosts'
num_genTab_hosts = get_num_hosts(genTab_hostfile)

mp_pipe = remote_dir + 'PIPE/code/MP-PIPE2/mp-pipe2'
...
if run_gentab:
    ...
    #################################################
    os.system('make -C ' + local_dir + 'PIPE/code/genTab/')
...
if run_mppipe:
    ...
    ###################################
    with open('data/protein_pairs.txt', 'r') as in_pairs, open('data/protein_pairs_indexes.txt','w') as out_pairs:
        out_pairs.write("%d\n" % num_known_pairs)
    ...
    os.system('cp ' + local_dir + 'PIPE/code/genTab/convertPairs.pl ./')
    ...
    #############################################################################
    print 'cp ' + local_dir + 'PIPE/code/MP-PIPE2/mp-pipe2.c ' + local_dir + 'PIPE/code/MP-PIPE2/mp-pipe2.c_bak'
    os.system('cp ' + local_dir + 'PIPE/code/MP-PIPE2/mp-pipe2.c ' + local_dir + 'PIPE/code/MP-PIPE2/mp-pipe2.c_bak')
    in_file = open(local_dir + 'PIPE/code/MP-PIPE2/mp-pipe2.c_bak', 'r')
    out_file = open(local_dir + 'PIPE/code/MP-PIPE2/mp-pipe2.c', 'w')
    ...
    print ('mpicc -O3 -fopenmp -Wall ' + local_dir + 'PIPE/code/MP-PIPE2/mp-pipe2.c -m64 -lm -o ' +
                        local_dir + 'PIPE/code/MP-PIPE2/mp-pipe2')
    os.system('mpicc -O3 -fopenmp -Wall ' + local_dir + 'PIPE/code/MP-PIPE2/mp-pipe2.c -m64 -lm -o ' + 
                local_dir + 'PIPE/code/MP-PIPE2/mp-pipe2')
    ...
    print ('mpirun -np ' + str(num_mp_pipe_hosts) + ' -hostfile ' + mp_pipe_hostfile + ' ' +
            ...
            remote_dir + 'PIPE/data/' + organism_name + '/data/protein_pairs_indexes.txt '+
            remote_dir + 'PIPE/data/' + organism_name + '/database ' + 
